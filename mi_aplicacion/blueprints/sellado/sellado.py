...
def proceso_sellado_dashboard():
    ...
    formularios_sellado = [
        ...
        {"nombre": "Formulario SE30", "url": url_for('se30.sellado_form_se30'), "icono": "fas fa-cogs", "descripcion": "Registro de parámetros de máquina SE30."},
        ...
        {"nombre": "Formulario SE47", "url": url_for('se47.sellado_form_se47'), "icono": "fas fa-cogs", "descripcion": "Registro de parámetros de máquina SE47."},
